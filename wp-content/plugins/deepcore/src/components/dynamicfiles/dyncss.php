...
if ( $thm_options['deep_sidebar_width'] ) {
	...
	if ( $thm_options['deep_blog_sidebar'] != 'both' ) {
		...
		@media ( min-width: 1280px ) {
			...
			.col-md-3.sidebar,
			.vc_col-sm-4.sidebar {
				width: ' . $thm_options['deep_sidebar_width'] . 'px !important;
			}
		}';
...
if ( $thm_options['deep_color_skin'] != 'e3e3e3' || $thm_options['deep_custom_color_skin'] ) {
	...
	.colorskin-custom .deep-single-product-addtocart button.button, .woocommerce    .colorskin-custom .woocommerce-Button  { box-shadow: 0 2px 14px -2px <?php echo esc_attr( $color ); ?>;}
	...
	body #wrap.colorskin-custom .deep-single-product-addtocart .wc_email_inquiry_button_container .wc_email_inquiry_email_button { background: <?php echo esc_attr( $color ); ?> !important;}
	body #wrap.colorskin-custom .deep-single-product-addtocart .wc_email_inquiry_button_container .wc_email_inquiry_email_button:hover { background: #222 !important;}
