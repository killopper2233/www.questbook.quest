...
class Webnus_Element_Widgets_Video_Play_Button extends \Elementor\Widget_Base {
	...
	public function get_title() {
		...
		return esc_html__( 'video play button', 'deep' );
	...
	public function get_icon() {
		...
		return 'deep-widget deep-eicon-video-play-button';
	...
	protected function render() {
		...
		$image_bg 		= $settings['img'];
		$align 			= $settings['image_alignment'];
		$width 			= $settings['img_width'];
		$height 		= $settings['img_height'];
		$img_alt 		= $settings['img_alt'];
		$show_alt_tag 	= $settings['show_alt_tag'];
		$img 			= '';
		$width 			= $width['size'];
		$height			= $height['size'];
