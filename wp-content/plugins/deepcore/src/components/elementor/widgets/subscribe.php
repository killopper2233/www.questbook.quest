...
class Webnus_Element_Widgets_Subscribe extends \Elementor\Widget_Base {
	...
	public function get_title() {
		...
		return esc_html__( 'Subscribe', 'deep' );
	...
	public function get_icon() {
		...
		return 'deep-widget deep-eicon-subscribe';
	...
	protected function render() {
		...
		$btn_text   	= $settings['btn_text'] ? $settings['btn_text'] : esc_html__( 'SUBSCRIBE', 'deep' );
