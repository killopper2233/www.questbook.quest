...
class Webnus_Element_Widgets_Facebook_Comments extends \Elementor\Widget_Base {
	...
	public function get_title() {
		...
		return __( 'Facebook Comments', 'deep' );
	...
	public function get_icon() {
		...
		return 'deep-widget deep-eicon-facebook-comments';
	...
	protected function render() {
		...
		if ( empty( $fb_api_code ) ) {
			esc_html_e( 'Please first set your Facebook APP ID in Options > Social Networks > Integrations and refresh this page to display buttons correctly.', 'deep' );
		}
