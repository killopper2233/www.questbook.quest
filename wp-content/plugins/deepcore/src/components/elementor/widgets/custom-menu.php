...
class Webnus_Element_Widgets_Custom_Menu extends \Elementor\Widget_Base {
	...
	public function get_title() {
		...
		return esc_html__( 'Custom Menu', 'deep' );
	...
	public function get_icon() {
		...
		return 'deep-widget deep-eicon-custom-menu';
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'selectors' 	=> [
					'#wrap {{WRAPPER}} .wn-custom-menu ul li a' => 'color: {{VALUE}} !important',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type' 			=> \Elementor\Controls_Manager::COLOR, //type
				'selectors' 	=> [
					'#wrap {{WRAPPER}} .wn-custom-menu ul li a:hover' => 'color: {{VALUE}} !important',
				],
			]
		);
