...
class Webnus_Element_Widgets_Shop_Products extends \Elementor\Widget_Base {
	...
	public function get_title() {
		...
		return esc_html__( 'Shop Products', 'deep' );
	...
	public function get_icon() {
		...
		return 'deep-widget deep-eicon-shop-products';
	...
	protected function register_controls() {
        ...
        $this->add_control(
            'more_options',
            [
                'label'             => 'This shortcode uses Options inside settings. Please go to this direction: Options > Shop',
