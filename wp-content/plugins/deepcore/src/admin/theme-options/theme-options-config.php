...
use Deep\Deep_Core;
    ...
    function webnus_redux_admin_css() {
        ...
        wp_enqueue_style( 'wn-redux-admin-css', DEEP_URL . 'src/admin/theme-options/assets/wn-redux-admin.css', false, DEEP_VERSION );
    }
    ...
    $args = array(
        ...
        'menu_title'           => esc_html__( 'Options', 'deep' ),
        'page_title'           => esc_html__( 'Options', 'deep' ),
    ...
    $ext_path = DEEP_COMPONENTS_DIR . '/admin/theme-options/extensions/';
    ...
    if ( ! Deep_Core::is_deep_theme() ) {
        Redux::setSection( $opt_name, array(
            ...
            'id'               => 'header_builder_opts',
            'subsection'       => true,
            'fields'    => array(
                array(
                    'title'     => esc_html__( 'Enable Header Builder', 'deep' ),
                    'subtitle'  => wp_kses( __( 'Follow <a href="https://webnus.net/deep-premium-wordpress-theme-documentation/header-builder/" target="_blank">this</a> article for more information.','deep' ), $html_allow ),
                    'id'        => 'deep_header_builder',
                    'type'      => 'switch',
                    'default'   => 0,
        ...
        Redux::setSection( $opt_name, array(
            ...
            'id'               => 'footer_builder_opts',
            'subsection'       => true,
            'fields'    => array(
                array(
                    'title'     => esc_html__( 'Enable Footer Builder', 'deep' ),
                    'subtitle'  => wp_kses( __( 'Follow <a href="https://webnus.net/deep-premium-wordpress-theme-documentation/footer-builder/" target="_blank">this</a> article for more information.','deep' ), $html_allow ),
                    'id'        => 'deep_footer_builder',
                    'type'      => 'switch',
                    'default'   => 0,
                    'on'        => esc_html__( 'Enable', 'deep' ),
                    'off'       => esc_html__( 'Disable', 'deep' ),
    ...
    Redux::setSection( $opt_name, array(
        ...
        'fields'            => array(
                ...
                array(
                    ...
                    'subtitle'  => esc_html__( 'You will able to change dashborad and Options logo with your own. Recommended size is 160x159', 'deep' ),
    ...
    Redux::setSection( $opt_name, array(
        ...
        'fields'    => array(
            ...
            array(
                ...
                'type'      => 'text',
                'default'   => esc_html__( 'Studio All Rights Reserved.', 'deep' ),
    ...
    if ( is_plugin_active( 'lifterlms/lifterlms.php' ) ) {
        // -> START LifterLMS Fields
        Redux::setSection( $opt_name, array(
            'title'     => esc_html__( 'Learning', 'deep' ),
            'id'        => 'laerning',
            'icon'      => 'ti-agenda',
        ));
        Redux::setSection( $opt_name, array(
            'title'     => esc_html__( 'LifterLMS', 'deep' ),
            'id'        => 'lifterlms_template_opts',
            'desc'      => esc_html__( 'In this section, you can select your custom Course(s), Lesson(s), and Membership(s) single pages', 'deep' ),
            'subsection'=> true,
            'fields'    => array(
                array(
                    'title'     => esc_html__( 'LifterLMS Custom Course Single Builder', 'deep' ),
                    'subtitle'  => esc_html__( 'This option will replace the course single page with the page that you have created with Elementor as the course single page.', 'deep' ),
                    'id'        => 'deep_custom_lifterlms_course',
                    'type'      => 'switch',
                    'default'   => '0',
                    'on'        => esc_html__( 'Enabled', 'deep' ),
                    'off'       => esc_html__( 'Disabled', 'deep' ),
                ...
                array(
                    'title'     => esc_html__( 'LifterLMS Course Single Page', 'deep' ),
                    'subtitle'  => esc_html__( 'Select the page that you have created as the course single page.', 'deep' ),
                    'id'        => 'deep_custom_lifterlms_course_page',
                    'type'      => 'select',
                    'data'      => 'page',
                    'required'  => array( 'deep_custom_lifterlms_course', '=', '1' ),
                ),
                array(
                    'title'     => esc_html__( 'LifterLMS Custom Lesson Single Builder', 'deep' ),
                    'subtitle'  => esc_html__( 'This option will replace the lesson single page with the page that you have created with Elementor as the lesson single page.', 'deep' ),
                    'id'        => 'deep_custom_lifterlms_lesson',
                    'type'      => 'switch',
                    'default'   => '0',
                    'on'        => esc_html__( 'Enabled', 'deep' ),
                    'off'       => esc_html__( 'Disabled', 'deep' ),
                ...
                array(
                    'title'     => esc_html__( 'LifterLMS Lesson Single Page', 'deep' ),
                    'subtitle'  => esc_html__( 'Select the page that you have created as the lesson single page.', 'deep' ),
                    'id'        => 'deep_custom_lifterlms_lesson_page',
                    'type'      => 'select',
                    'data'      => 'page',
                    'required'  => array( 'deep_custom_lifterlms_lesson', '=', '1' ),
                ),
                array(
                    'title'     => esc_html__( 'LifterLMS Custom Membership Single Builder', 'deep' ),
                    'subtitle'  => esc_html__( 'This option will replace the membership single page with the page that you have created with Elementor as the membership single page.', 'deep' ),
                    'id'        => 'deep_custom_lifterlms_membership',
                    'type'      => 'switch',
                    'default'   => '0',
                    'on'        => esc_html__( 'Enabled', 'deep' ),
                    'off'       => esc_html__( 'Disabled', 'deep' ),
                ...
                array(
                    'title'     => esc_html__( 'LifterLMS Membership Single Page', 'deep' ),
                    'subtitle'  => esc_html__( 'Select the page that you have created as the membership single page.', 'deep' ),
                    'id'        => 'deep_custom_lifterlms_membership_page',
                    'type'      => 'select',
                    'data'      => 'page',
                    'required'  => array( 'deep_custom_lifterlms_membership', '=', '1' ),
                ),
            ),
        ) );
    }
