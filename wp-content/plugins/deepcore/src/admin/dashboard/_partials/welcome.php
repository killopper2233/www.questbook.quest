...
if ( ! defined( 'ABSPATH' ) ) {
	...
	do_action( 'deep_admin_dashboard' );
	...
	$theme_option_address = admin_url("themes.php?page=wn-admin-options");
	...
	<div id="webnus-dashboard" class="wrap about-wrap">
		...
		<?php do_action( 'deep/dashboard/update' ); ?>
		<?php do_action( 'deep/dashboard/message' ); ?>
			...
			<div id="wSystemStatus" class="w-row">
				<div class="w-col-sm-12">
					<div class="w-box">
						...
						<div class="w-box-content">
							<?php esc_html_e('When you install a demo it provides pages, images, Options, posts, sliders, widgets and etc. IMPORTANT: Please check the status below to see if your server meets all essential requirements for a successful import.','deep') ?>
							<!-- PHP Version -->
			...
			<div class="w-row">
				<div class="w-col-sm-12">
					<div class="w-box change-log">
						<div class="w-box-head">
							<?php esc_html_e('Changelog','deep'); ?>
						</div>
						<div class="w-box-content">
						<?php require_once DEEP_COMPONENTS_DIR . 'changelog/changelog.php'; ?>
