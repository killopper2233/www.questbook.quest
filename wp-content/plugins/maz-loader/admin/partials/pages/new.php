			...
			<div class="top-menu">
				...
				<div class="fields-items-selector">
					...
					<div class="field-items">
						...
						<div class="field-item mzldr-pro mzldr-pro-upgrade-button" data-title="<?php _e( 'Lottie', 'maz-loader' ); ?>" data-item="percentage_counter" title="<?php _e( 'Lottie', 'maz-loader' ); ?>">
							<div class="bottom"><span class="icon dashicons dashicons-admin-customizer"></span></div>
							<h3 class="title"><?php _e( 'Lottie', 'maz-loader' ); ?></h3>
							<span class="pro-label"><span class="icon dashicons dashicons-lock"></span><?php _e( 'Pro', 'maz-loader' ) ?></span>
						</div>
						<!-- FREE-END -->
					</div>
				...
				<div class="setting-page is-active" data-page-id="fields-list">
					...
					if ( is_object( $this->loader ) && count( (array) $this->loader ) ) {
						...
						foreach ( $field_data as $fd ) {
							$class_name = 'MZLDR_' . ucfirst( $fd->type ) . '_Field';
							...
							?>
							<div class="item"><?php $field->renderFieldSettings( true ); ?></div>
							<?php
						}
					}
					?>
