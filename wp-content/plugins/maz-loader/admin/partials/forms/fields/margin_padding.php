...
?>
<div
	class="mzldr-margin-padding-item<?php echo esc_attr( $extra_classes ); ?>"
...
>
	<div class="mp_items">
		<div class="mp_item">
			<input type="text"<?php echo wp_kses_data($bind_atts); ?> value="<?php echo esc_attr( $item_top ); ?>" name="<?php echo esc_attr( $this->get_field_data( 'name_top' ) ); ?>" data-field-id="<?php echo esc_attr( $this->get_field_data( 'field_id' ) ); ?>" class="mp-input-item top" />
			<span class="label"><?php _e( 'TOP', 'maz-loader' ); ?></span>
		</div>
		<div class="mp_item">
			<input type="text"<?php echo wp_kses_data($bind_atts); ?> value="<?php echo esc_attr( $item_right ); ?>" name="<?php echo esc_attr( $this->get_field_data( 'name_right' ) ); ?>" data-field-id="<?php echo esc_attr( $this->get_field_data( 'field_id' ) ); ?>" class="mp-input-item right" />
			<span class="label"><?php _e( 'RIGHT', 'maz-loader' ); ?></span>
		</div>
		<div class="mp_item">
			<input type="text"<?php echo wp_kses_data($bind_atts); ?> value="<?php echo esc_attr( $item_bottom ); ?>" name="<?php echo esc_attr( $this->get_field_data( 'name_bottom' ) ); ?>" data-field-id="<?php echo esc_attr( $this->get_field_data( 'field_id' ) ); ?>" class="mp-input-item bottom" />
			<span class="label"><?php _e( 'BOTTOM', 'maz-loader' ); ?></span>
		</div>
		<div class="mp_item">
			<input type="text"<?php echo wp_kses_data($bind_atts); ?> value="<?php echo esc_attr( $item_left ); ?>" name="<?php echo esc_attr( $this->get_field_data( 'name_left' ) ); ?>" data-field-id="<?php echo esc_attr( $this->get_field_data( 'field_id' ) ); ?>" class="mp-input-item left" />
