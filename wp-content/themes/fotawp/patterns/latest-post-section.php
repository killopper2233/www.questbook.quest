...
<h1 class="wp-block-heading" style="margin-top:var(--wp--preset--spacing--20);font-size:52px;font-style:normal;font-weight:500;line-height:1">Recent News and Articles</h1>
<!-- /wp:heading --></div>
<!-- /wp:column -->
...
<p style="font-size:18px;font-style:normal;font-weight:400">Cras tincidunt tellus at mi tristique rhoncus. Etiam dapibus rutrum leo consectetur accumsan. Vivamus viverra ante turpis, dignissim condimentum elit egestas sit amet. Phasellus dignissim condimentum elit egestas sit amet. Phasellus</p>
<!-- /wp:paragraph -->
...
<div class="wp-block-column is-vertically-aligned-center" style="padding-top:0;padding-right:0;padding-bottom:0;padding-left:0;flex-basis:38%"><!-- wp:cover {"dimRatio":10,"overlayColor":"foreground","minHeight":149,"minHeightUnit":"px","className":"is-style-fotawp-cover-round-style","style":{"spacing":{"padding":{"top":"0","right":"0","bottom":"0","left":"0"}}}} -->
