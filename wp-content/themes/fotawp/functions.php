...
if (!function_exists('fotawp_styles')) :
    function fotawp_styles()
    {
        ...
        wp_enqueue_style('fotawp-swiper-bundle-style', get_template_directory_uri() . '/assets/css/swiper-bundle.css');
        ...
        wp_enqueue_script('fotawp-swiper-bundle-scripts', get_template_directory_uri() . '/assets/js/swiper-bundle.js', array(), '9.2.3', true);
