<?php
/**
 * Post archive 3 columns block pattern
 */
return array(
    'title'      => __( 'Post archive (3 columns)', 'chuo' ),
    ...
    'content'    => '<!-- wp:group {"style":{"spacing":{"margin":{"top":"4rem"}}},"layout":{"inherit":true,"type":"constrained"}} -->
                    ...
                    <!-- wp:query {"queryId":1,"query":{"perPage":"9","pages":0,"offset":"1","postType":"post","order":"desc","orderBy":"date","author":"","search":"","exclude":[],"sticky":"exclude","inherit":true},"displayLayout":{"type":"flex","columns":3}} -->
