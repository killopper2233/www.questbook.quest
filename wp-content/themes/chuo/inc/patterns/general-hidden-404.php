...
return array(
	...
	'content'  => '<!-- wp:group {"tagName":"main","style":{"spacing":{"padding":{"right":"1em","left":"1em"}}},"layout":{"inherit":true}} -->
                    ...
                    <p class="has-text-align-center">' . wp_kses_post( __( 'This page could not be found. Maybe try a search?', 'chuo' ) ) . '</p>
                    <!-- /wp:paragraph -->
                    
                    <!-- wp:search {"label":"' . esc_html_x( 'Search', 'label', 'chuo' ) . '","showLabel":false,"width":50,"widthUnit":"%","buttonText":"' . esc_html_x( 'Search', 'label', 'chuo' ) . '","buttonUseIcon":true,"align":"center","backgroundColor":"primary"} /-->
                    <!-- /wp:group --></main>
                    <!-- /wp:group --></div>
                    <!-- /wp:group --></main>
                    <!-- /wp:group -->',
